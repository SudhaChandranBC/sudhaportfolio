...
export default function Footer() {
  ...
  return (
    <footer className="py-12 bg-[#0a0a0b] border-t border-white/10">
      <div className="container mx-auto px-6 lg:px-16">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-white font-medium">Sudha Chandran BC</p>
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/about#experience" className="text-sm text-neutral-400 hover:text-white transition-colors">Experience</Link>
            <Link href="/work" className="text-sm text-neutral-400 hover:text-white transition-colors">Projects</Link>
